...
describe("DFS recursive", function () {
  it("return an array of the nodes searched using DFS recursively", function () {
    // build complex graph
    //
    //                       Q --P -- S
    //                      /  \ |      \
    ...
    let result = graph.depthFirstSearchRecursive(T);
...
describe("BFS recursive", function () {
  it("should return an array of the nodes searched using BFS recursively", function () {
    // build complex graph
    //
    //                       Q --P -- S
    //                      /  \ |      \
    ...
    let results = graph.breadthFirstSearchRecursive(S);
